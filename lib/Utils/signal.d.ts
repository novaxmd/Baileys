import type { SignalRepositoryWithLIDStore } from '../Types.js';
...
import { type BinaryNode, type FullJid } from '../WABinary.js';
import type { USyncQueryResultList } from '../WAUSync.js';
