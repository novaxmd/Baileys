...
export type InteractiveMessageOptions = {
	interactiveMessage: {
		...
		footer?: string
		thumbnail?: string
		image?: WAMediaUpload | { url: string }
		video?: WAMediaUpload | { url: string }
		document?: WAMediaUpload
		mimetype?: string
		fileName?: string
		jpegThumbnail?: WAMediaUpload | { url: string }
		contextInfo?: proto.IContextInfo
...
export type GroupStatusMessageOptions = {
	groupStatusMessage: AnyMediaMessageContent | { text: string } | { message: proto.IMessage }
}
...
export type PaymentMessageOptions = {
	requestPaymentMessage: {
		...
		expiry?: number
		note?: string
		sticker?: { stickerMessage: proto.Message.IStickerMessage }
		background?: any
	}
}
...
export type ProductSendOptions = {
	productMessage: {
		title: string
		description?: string
		thumbnail?: WAMediaUpload | { url: string }
		productId: string
		retailerId?: string
		url?: string
		body?: string
...
export type PollResultMessageOptions = {
	pollResultMessage: {
		name: string
		pollVotes: Array<{ optionName: string; optionVoteCount: number | string }>
	}
}
...
export type AnyRegularMessageContent = (
	...
	| TemplateButtonMessageOptions
	| ListMessageOptions
	| InteractiveMessageOptions
	| GroupStatusMessageOptions
	| AlbumSendOptions
